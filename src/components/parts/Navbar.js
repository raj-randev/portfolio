            ...
            <div className='navMenuContainer'>
                ...
                <div className='navList'>
                    <ul>
                        ...
                        <li key={5}><a href='https://www.linkedin.com/in/rajan-randev' target='_blank' rel="noreferrer" className='navButton'><FontAwesomeIcon style={{fontSize: '40px'}} color='#ffffff' icon={faLinkedin}/> <p>LinkedIn</p></a></li>
                    </ul>
                </div>
            </div>
        </div>
